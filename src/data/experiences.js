import { formatMonthPeriod, localizeCollection } from 'data/localization';

export const experienceDefinitions = [
  {
    id: 'simpliciti',
    company: 'SIMPLICITI',
    logo: 'company-logos/simpliciti.svg',
    dates: { start: '2025-11', end: null },
  ...
  },
  {
    ...
    logo: 'company-logos/sogeti.svg',
    dates: { start: '2024-09', end: '2025-09' },
  ...
  },
  {
    ...
    logo: 'company-logos/gautier-semences.svg',
    logoClass: 'experience-logo--gautier',
    dates: { start: '2024-04', end: '2024-08' },
...
export const getExperiences = (language) =>
  localizeCollection(experienceDefinitions, experienceContent, language).map((experience) => ({
    ...experience,
    period: formatMonthPeriod(experience.dates, language),
  }));
