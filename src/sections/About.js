          ...
          <div style={{
            ...
            <div className="card" style={{
              ...
              <p style={{
                ...
                Data Engineer passionné par la construction de pipelines robustes, 
                la qualité des données et la mise en production. Je transforme les données 
                en insights actionnables pour des solutions innovantes.
              </p>
