  ...
  return (
    <section id="skills" className="section">
      <div className="section-content">
        ...
        {/* Flex row for desktop/mid, column for mobile */}
        <div
          style={{
            display: 'flex',
            flexDirection: 'row',
        ...
        >
          ...
          >
            ...
            >
              Je continue d'apprendre et d'explorer de nouvelles technologies pour rester à jour
