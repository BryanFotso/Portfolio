const projects = [
  {
    ...
    description: "Pipeline de données moderne sur Azure (Data Factory, Data Lake, Synapse) orchestré avec dbt pour la transformation et la qualité des données.",
    techs: [
  ...
  },
  {
    ...
    description: "API REST sécurisée pour la gestion d’utilisateurs et d’authentification JWT. Déploiement Docker, tests Pytest, CI/CD GitHub Actions.",
    techs: [
  ...
  },
  {
    ...
    description: "Visualisation interactive des KPIs métiers, connectée à une base PostgreSQL. Automatisation de la collecte et du reporting.",
    techs: [
            ...
            <div key={idx} className="card" style={{
              ...
              <div style={{
                ...
                {project.techs.map((tech, tIdx) => (
                  <span key={tIdx} className="tech-tag" style={{
