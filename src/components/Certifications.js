...
const certifications = [
  {
    ...
    issuer: "Microsoft",
    date: "2024",
    description: "Certification officielle sur la conception et la mise en œuvre de solutions de données sur Azure (Data Factory, Data Lake, Synapse, Databricks).",
    color: "#007aff",
    techs: [
  ...
  },
  {
    ...
    issuer: "Udemy",
    date: "2023",
    description: "Formation avancée sur dbt, l'orchestration de transformations SQL et la modélisation de données moderne.",
    color: "#af52de",
    techs: [
